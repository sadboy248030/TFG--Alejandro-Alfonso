...
public class Character : MonoBehaviour
{
    ...
    public int magicDefenseGrowth = 1;
    ...
    private void LevelUp()
    {
        ...
        // --- AÑADIDO: Incrementar los demás stats ---
        baseMagicAttack += magicAttackGrowth;
        baseMagicDefense += magicDefenseGrowth;
        baseSpeed += speedGrowth;
        // --- FIN AÑADIDO ---
